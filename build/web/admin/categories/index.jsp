                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${categoryList}" var="category">
                                            <tr>
                                                <td>${index}</td>
                                                <td>${category.name}</td>
                                                <td><img src="${category.image}" alt="alt" style="height: 150px"/></td>
                                                <td>
                                                    <a href="EditCategoryServlet?categoryId=${category.id}" class="btn btn-primary">Edit</a>
                                                </td>
                                                <td>
                                                    <a href="DeleteCategoryServlet?categoryId=${category.id}" class="btn btn-danger">Delete</a>
                                                </td>
                                            </tr>
