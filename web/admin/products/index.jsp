                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${productList}" var="product">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="EditProductServlet?productId=${product.id}" class="btn btn-primary">Edit</a>
                                                </td>
                                                <td>
                                                    <a href="DeleteProductServlet?productId=${product.id}" class="btn btn-danger" >Delete</a>
                                                </td>
